...
var GeniusClient = /** @class */ (function () {
    function GeniusClient(config) {
        ...
        this.makeUrl = function (params) {
            ...
            return "http://" + _this.config.CEDHostname + ":8080/v2/pos?" + queryString;
        };
        this.config = config;
    }
    ...
    GeniusClient.prototype.InitiateTransaction = function (TransportKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl({ TransportKey: TransportKey, Format: "JSON" });
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
    ...
    GeniusClient.prototype.CheckStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl({ Action: "Status", Format: "JSON" });
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
    ...
    GeniusClient.prototype.Cancel = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl({ Action: "Cancel", Format: "JSON" });
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    GeniusClient.prototype.AddItem = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "AddItem", Format: "JSON" }, item));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    GeniusClient.prototype.DiscountItem = function (discountItem) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "DiscountItem", Format: "JSON" }, discountItem));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    GeniusClient.prototype.DeleteItem = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "DeleteItem", Format: "JSON" }, item));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
     ...
     */
    GeniusClient.prototype.DeleteAllItems = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "DeleteAllItems", Format: "JSON" }, params));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    GeniusClient.prototype.UpdateItem = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "UpdateItem", Format: "JSON" }, item));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
    ...
    GeniusClient.prototype.UpdateTotal = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.makeUrl(__assign({ Action: "UpdateTotal", Format: "JSON" }, params));
                        return [4 /*yield*/, fetch(url).then(function (r) { return r.json(); })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
